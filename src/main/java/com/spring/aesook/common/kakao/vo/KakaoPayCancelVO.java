...
public class KakaoPayCancelVO {
	...
	private KakaoCanceledAmountVO canceled_amount;
	...
	public KakaoCanceledAmountVO getCanceled_amount() {
		return canceled_amount;
	}

	public void setCanceled_amount(KakaoCanceledAmountVO canceled_amount) {
