				...
				<form class="login100-form validate-form" action="" method="post" id="findIdForm">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" type="button" onclick="checkz()">ID 찾기</button>
						</div>
						<a href="javascript:history.go(-1);" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							취소
